...
CREATE TABLE attendance (
    ...
    rfid_tag INT REFERENCES persons(rfid_tag) ON DELETE CASCADE,
    timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    status VARCHAR(10) CHECK (status IN ('present', 'absent')),
    UNIQUE (schedule_id, student_id) -- prevents duplicates
);


INSERT INTO persons (name, rfid_tag, role, id_number, password) VALUES
('Nitin Verma', 'B2F7AF6A','student','2500032073','$2a$10$xqvlgnoqwdiIbauJrYUuC.aL34qhVoLaTeJ6yxqN6RMaLE0.FyCVK'),
